...
import com.vectorwing.games.minesweeper.gui.TileOLD.TileFrame;
 ...
 **/
public class TileGridOLD extends JPanel {
	...
	private ArrayList<ArrayList<TileOLD>>	tile_array;
	...
	public TileGridOLD(GameInfo info)
	{
		this.tile_array = new ArrayList<ArrayList<TileOLD>>();
		this.info = info;
		this.initTimer();
		this.resetTimer();
		this.initGraphics();
	...
	public ArrayList<ArrayList<TileOLD>> getTileArray()
	{
	...
	private void startGame()
	{
		...
		{
			gbc.gridy = iter_y;
			ArrayList<TileOLD> tilerow = new ArrayList<TileOLD>();
			for (int iter_x = 0; iter_x < this.amount_x; iter_x++)
			{
				TileOLD tile = new TileOLD(iter_x, iter_y, img_tile);
	 ...
	 */
	public void updateLogic(TileOLD tile)
	{
	...
	class TileMouseAdapter extends MouseAdapter
	{
		...
		public TileMouseAdapter(TileOLD tile)
		{
			this.tile = tile;
		}
